    ...
    <div class="row">
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <br />
            <div class="row">
              <label class="col-form-label col-2">Phone Number :</label>
              <div class="col-9">
                <input
            ...
            <br />
            <div class="row">
              <label class="col-form-label col-2">Payment Method :</label>
              <div class="col-9">
                <input
            ...
            <br />
            <div class="row">
              <label class="col-form-label col-2">Type :</label>
              <div class="col-9">
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0 mb-3">
            <div class="d-flex align-items-center">
              <h6 class="mb-0 text-success">List Transactions</h6>
              <button
    ...
    fetchData() {
      ...
      this.$apollo
        ...
        .then((result) => {
          ...
          self.rows = result.data.transactions.nodes;
        })
        .catch((error) => {});
    },
