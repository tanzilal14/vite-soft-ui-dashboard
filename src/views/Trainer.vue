            ...
            <div class="table-responsive">
              ...
              >
                <template #table-row="props" :index="index" :columns="columns">
                  ...
                  <span v-else-if="props.column.field === 'trainer_image_url'"
                    ><img
                      style="width: 64px"
                      :src="props.formattedRow[props.column.field]"
                      @click="
                        openimage(props.formattedRow[props.column.field])
                      "
                  /></span>
        ...
        >
          ...
          <div class="modal-body">
            ...
            <div
              v-if="
                form.id != '' &&
                form.trainer_image_url != '' &&
                form.trainer_image_url != null
              "
              class="form-group"
            >
              <img style="width: 128px" :src="form.trainer_image_url" />
            </div>
            <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    edit(data) {
      ...
      this.form.trainer_image_url = data.trainer_image_url;
      this.modal.show();
      return false;
    },
    async save() {
