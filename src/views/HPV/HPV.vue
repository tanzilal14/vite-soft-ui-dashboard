    ...
    <form class="histology-form" @submit.prevent="">
      ...
      <card-box title="Sample Information">
        <template #content>
          ...
          <text-input label="First day of last menstruation (HPHT)">
            <template #input>
              <Datepicker v-model="date" :enable-time-picker="false">
              </Datepicker>
            </template>
          </text-input>
          <text-input label="Last Pap’s smear date">
            <template #input>
              <Datepicker v-model="date" :enable-time-picker="false">
              </Datepicker>
            </template>
          </text-input>
          <radio-input label="Sample" :main="false">
          ...
          <radio-input label="Gynaecology Status">
...
export default {
  ...
  beforeMount() {
    ...
    this.$store.state.currentUrlPage = ["/hpv", "/form-hpv"];
  },
  methods: {
    makeId(data) {
